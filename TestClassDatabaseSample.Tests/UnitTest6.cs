...
public class UnitTest6 : IClassFixture<IntegrationTestFixture>
{
    private readonly SqlConnection _connection;
    private readonly ITestOutputHelper _testOutputHelper;

    public UnitTest6(IntegrationTestFixture integrationTestFixture, ITestOutputHelper testOutputHelper)
    {
