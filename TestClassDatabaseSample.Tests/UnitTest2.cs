...
public class UnitTest2 : IClassFixture<IntegrationTestFixture>
{
    private readonly SqlConnection _connection;
    private readonly ITestOutputHelper _testOutputHelper;

    public UnitTest2(IntegrationTestFixture integrationTestFixture, ITestOutputHelper testOutputHelper)
    {
