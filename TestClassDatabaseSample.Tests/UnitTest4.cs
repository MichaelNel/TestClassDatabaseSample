...
public class UnitTest4 : IClassFixture<IntegrationTestFixture>
{
    private readonly SqlConnection _connection;
    private readonly ITestOutputHelper _testOutputHelper;

    public UnitTest4(IntegrationTestFixture integrationTestFixture, ITestOutputHelper testOutputHelper)
    {
