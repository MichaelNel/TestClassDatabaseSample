...
public class UnitTest10 : IClassFixture<IntegrationTestFixture>
{
    private readonly SqlConnection _connection;
    private readonly ITestOutputHelper _testOutputHelper;

    public UnitTest10(IntegrationTestFixture integrationTestFixture, ITestOutputHelper testOutputHelper)
    {
